...
import type { SaleOrder, OrderFilters } from "../types/orders";
import { dummySaleOrders, saleOrderStatuses } from "../data/dummyOrders";

export function SaleOrders() {
  const navigate = useNavigate();
  const [orders, setOrders] = useState<SaleOrder[]>(dummySaleOrders);
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Sale Orders</h1>
              <p className="text-gray-600">Manage your customer sale orders and track their fulfillment status</p>
            </div>
            <button
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-xl font-bold text-gray-900">{packedOrders}</p>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">{order.trackingNumber || 'Not available'}</p>
                      </div>
                    </div>
